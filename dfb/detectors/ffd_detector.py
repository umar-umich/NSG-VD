...
base_path = base_path.replace('detectors', 'lib')
...
class FFDDetector(AbstractDetector):
    ...
    def build_backbone(self, config):
        ...
        # pretrained_path = 
        pretrained_path = f'{base_path}/xception-b5690688.pth'
...
def get_templates():
    templates_list = []
    for i in range(10): 
        # img = imread('/data/Kutub/DEEPFAKES/dfd-report/dfd_report/DFB/training/lib/component/MCT/template{:d}.png'.format(i))
        lib_path = base_path.replace('detectors', 'lib')
        img = imread(f'{lib_path}/component/MCT/template{str(i)}.png')
